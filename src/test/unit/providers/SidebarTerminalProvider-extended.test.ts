  ...
  describe('Settings integration', () => {
    ...
    it('should handle configuration changes', () => {
      ...
      expect(() => {
        ...
        configChangeEvent.affectsConfiguration('aiTerminal');
      }).to.not.throw();
    ...
    it('should get terminal configuration', () => {
      ...
      const terminalConfig = mockVscode.workspace.getConfiguration('aiTerminal');
  ...
  describe('Alt+Click integration', () => {
    ...
    it('should handle Alt+Click configuration changes', () => {
      ...
      const configChangeEvent = {
        affectsConfiguration: sinon.stub().callsFake((section: string) => {
          return (
            ...
            section === 'aiTerminal.altClickMovesCursor'
          );
        }),
      };
      ...
      expect(() => {
        ...
        configChangeEvent.affectsConfiguration('aiTerminal.altClickMovesCursor');
      }).to.not.throw();
