...
import { generateNonce, getTerminalConfig, normalizeTerminalInfo } from '../utils/common';
import { showError, showSuccess, TerminalErrorHandler } from '../utils/feedback';
        ...
        <style>
            *, *::before, *::after {
            ...
            #terminal-body.terminal-container.active {
                border-color: var(--vscode-focusBorder, transparent) !important;
            }
